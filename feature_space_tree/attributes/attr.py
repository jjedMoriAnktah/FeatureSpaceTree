...
# FIXME: It wouldbe a good thing to normalize the convention to name each inherited class
# This is because sometimes I use the super class as a sufix, and other times as
# a prefix.

# FIXME: I don't like this constructions, all Terms receives the object kwargs
# and each class process it. This gives to each Term class a second resposability
# (process the kawargs). This preprocessing could be done in the Factory, in this way
# we delegate ALL the resposability to the factory.
        ...
        for f_src in terms.kwargs["source"]:
            ...
            if f_src in shelf and terms.kwargs["lazy"]:
                ...
                if 'raw_string_normalizers' in terms.kwargs:
                    empty_raw_string_normalizer = \
                    Util.decorate_raw_string(empty_raw_string_normalizer,
                ...
                if 'by_token_normalizers' in terms.kwargs:
                    ...
                    Util.decorate_by_token_normalizer(empty_by_token_normalizer,
